...
async function get_upcoming_market_holidays() {
    if (!apiKey) {
    ...
    try {
        // Fetch IPO data
        const response = await axios.get(`https://api.polygon.io/v1/marketstatus/upcoming?apiKey=${apiKey}`);
...
export default get_upcoming_market_holidays;
