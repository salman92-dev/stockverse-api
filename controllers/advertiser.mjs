...
async function advertiser_feedback(req, res){
    const { username,email,phone,company_name,company_website,feedback } = req.body;
    ...
    try {
      ...
      <div style="background-color: #082e99; color: white; padding: 20px; text-align: center;">
        <h2 style="margin: 0; font-size: 24px;">Bussiness Company Message</h2>
      </div>
...
export default advertiser_feedback;